		...
		<view class="refund-list">
			<view class="refund-item" v-for="(item, index) in refundList" :key="index">
				<view class="refund-header">
					...
					<text class="refund-status" :class="item.status">{{getStatusText(item.status)}}</text>
				</view>
				...
				<view class="refund-footer">
					<button class="action-btn reject" @tap.stop="handleReject(item)" v-if="item.status === 'pending'">拒绝</button>
					<button class="action-btn approve" @tap.stop="handleApprove(item)" v-if="item.status === 'pending'">通过</button>
